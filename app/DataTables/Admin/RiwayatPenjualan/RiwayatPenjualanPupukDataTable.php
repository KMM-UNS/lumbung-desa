...
class RiwayatPenjualanPupukDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                $btn = '<div class="btn-group">'; $btn = $btn . '<a href="' . route('admin.riwayat.riwayatpenjualanpupuk.show', $row->id) . '" class="btn btn-info buttons-show">Detail</a>';
                return $btn;
            });
        }
