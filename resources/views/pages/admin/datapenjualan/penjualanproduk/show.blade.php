  ...
  <div class="panel panel-inverse">
    ...
    <div class="panel-body">
      <div class="form-group">
        ...
        <input disabled class="form-control" value="{{{ $data->pembeli->nama ?? old('nama_petani') }}}">
        ...
        <input disabled type="text" id="produk_id" name="produk_id" class="form-control" value="{{{ $data->produk->tanaman->nama ?? old('produk_id') }}}">
