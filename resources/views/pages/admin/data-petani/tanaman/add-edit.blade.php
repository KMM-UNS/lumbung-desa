...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.data-petani.tanaman.update', $data->id) : route('admin.data-petani.tanaman.simpan') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
