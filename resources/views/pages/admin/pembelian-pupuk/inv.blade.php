           ...
           <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($data as $datas)
                                <tr>
                                    <td class="col-md-9">{{ $pupuk_id }}</td>
                                    <td class="col-md-9">{{ $jumlah }}</td>
                                    <td class="col-md-3"><i class="fa fa-inr"></i>@currency($harga)</td>
                                    <td class="text-right"><h2><strong>@currency($total)</strong></h2></td>
                                </tr>
                            @endforeach
                            <tr>
                ...
                <div class="row">
                    <div class="receipt-header receipt-header-mid receipt-footer">
                        <div class="col-xs-8 col-sm-8 col-md-8 text-left">
                            <div class="receipt-right">
                               <h5 style="color: rgb(140, 140, 140);">Terimakasih Atas Kerjasamanya!</h5>
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                           <div class="receipt-left">
