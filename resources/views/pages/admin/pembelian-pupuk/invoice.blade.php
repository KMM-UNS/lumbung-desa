                ...
                <div class="row">
                    <div class="receipt-header receipt-header-mid">
                        <div class="col-xs-8 col-sm-8 col-md-8 text-left">
                            <div class="receipt-right">
                                @foreach ($pembelianPupuk as $key => $item)
                                <h5>Suplier : {{ $item->penjual->instansi }}</h5>
                                @endforeach
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="receipt-left">
                                <h3>INVOICE PEMBELIAN PUPUK # {{ $no_pembelian }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $datas->detailpupuk->nama }}</td>
                                <td>{{ $datas->jumlah }}</td>
                                <td>@currency($datas->harga)</td>
                                <td>@currency($datas->total)</td>
                            </tr>
                            @endforeach
                        </tbody>
                        @if ($data)
                        <tr>
                            ...
                            <td class="text-left text-danger">
                                <h2><strong><i class="fa fa-inr"></i> @currency($data->sum('total')) </strong></h2>
                            </td>
                        </tr>
                        @endif
                    </table>
