        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="hidden" id="musim_panen_id" name="musim_panen_id" class="form-control" autofocus data-parsley-required="true" value="{{ isset($data) ? $data->musim_panen_id : $id }}">
                </div>
            </div>
        </div>
        <div class="form-group">
